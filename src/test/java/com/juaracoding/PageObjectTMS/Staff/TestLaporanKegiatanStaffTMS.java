...
public class TestLaporanKegiatanStaffTMS {

	WebDriver driver;
	private LaporanKegiatanStaffPage laporanKegiatanStaffPage = new LaporanKegiatanStaffPage();
	private static ExtentTest extentest;

	public TestLaporanKegiatanStaffTMS() {
	...
	public void staff_enter_nik_password_valid() {
		laporanKegiatanStaffPage.login4("D6200927", "1997-10-23");
		HooksTMSAStaff.delay(2);
